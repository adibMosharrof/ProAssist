# DST Training Data Transformation Plan

**DST = Dialog State Tracking** (not Daylight Saving Time)

## Overview

This document outlines the detailed implementation plan for transforming the current enhanced Dialog State Tracking (DST) + SPEAK data format into training data. While inspired by ProAssist's approach, this implementation includes key differences:
